...
const EMAIL_INPUT = 'input[app-test-ref="employee-email"]';
const PASSWORD_INPUT = 'input[app-test-ref="password"]';
const LOGIN_BTN = 'button[app-test-ref="login-btn"]';
const REMEMBER_CHECKBOX =
    'div[app-test-ref="remember-checkbox"] > div > div > div > input';
