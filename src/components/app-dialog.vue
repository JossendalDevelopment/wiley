<template>
  <v-dialog
    ...
    style="z-index:2000;"
  >
    <v-dialog v-model="isLoading" lazy persistent fill-height content-class="elevation-0">
      <p class="text-xs-center pt-4">
        <v-progress-circular :size="70" :width="7" indeterminate lazy color="white" />
      </p>
    </v-dialog>
    <slot>
      <v-card color="transparent" flat>
        <v-layout align-center justify-space-between>
          <v-card-title class="mb-0 pb-0">
            <h2
              class="ml-1"
              style="display:inline; color:#FFF; font-family:DIN Condensed; font-weight:700; letter-spacing:5px;"
            >
...
#inspire
  ...
  > div.v-card__text.modal-content
  > div
  > div
  > div.v-input__slot.transparent:before {
